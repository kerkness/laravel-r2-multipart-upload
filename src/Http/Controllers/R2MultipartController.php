...
namespace Kerkness\LaravelR2MultipartUpload\Http\Controllers;
...
class R2MultipartController extends Controller
{
    protected $client;
    ...
    public function __construct()
    {
        ...
        $this->client = Storage::disk('r2')->getClient();
    ...
    */
    public function createMultipartUpload(Request $request)
    {
        ...
        return response()
            ->json([
                'uploadId' => base64_encode($result['UploadId']),
                'key'      => $result['Key'],
            ]);
    }
    ...
    */
    public function getUploadedParts(Request $request, $uploadId)
    {
        ...
        $uploadId = base64_decode($uploadId);
